		...
		<table border="2" cellpadding="5">
			    ...
			    <thead>
			      <tr style="font-size: 25px; color: #000080; background-color: #FFA07A;">
			        ...
			        <th><b>Delete Category </b></th>
			        
			                
			      </tr>
			    </thead>
			    <tbody >
					  <s:forEach items="${requestScope.catlist}" var="category"> 
                 
					      <tr>
					      
					        <td align="center">${category.categoryId}</td>
					        <td align="center">${category.name}</td>
					         <td align="center"><a href="./deleteCategory.htm?catid=${category.categoryId}">Delete</a></td>
					      </tr>    
					   </s:forEach>
