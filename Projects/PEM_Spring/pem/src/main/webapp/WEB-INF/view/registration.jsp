...
<body>
<jsp:include page="indexmenu.jsp"/><br><br>
	<!-- login -->
	...
	<div class="login-section-agileits">
		...
		<form action="./submitUserRegister.htm" method="post">
			<div class="w3ls-icon">
				...
				<input type="text" class="lock" name="name" placeholder="Name" required="" />
			</div>
			
			<div class="w3ls-icon">
				<span class="fa fa-user" aria-hidden="true"></span>
				<input type="text" class="lock" name="email" placeholder="Email" required="" />
			</div>
			
			<div class="w3ls-icon">
				<span class="fa fa-user" aria-hidden="true"></span>
				<input type="text" class="lock" name="address" placeholder="Address" required="" />
			</div>
			
			<div class="w3ls-icon">
				<span class="fa fa-user" aria-hidden="true"></span>
				<input type="text" class="lock" name="loginName" placeholder="loginName" required="" />
			</div>
